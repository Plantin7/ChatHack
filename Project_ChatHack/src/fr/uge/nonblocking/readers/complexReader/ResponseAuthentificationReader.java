...
public class ResponseAuthentificationReader implements Reader<ResponseAuthentification>{
	private enum State {DONE, WAITING_MSG, ERROR}
	...
	@Override
	public ResponseAuthentification get() {
		if (state != State.DONE) {
			throw new IllegalStateException();
		}
		return new ResponseAuthentification(message);
	}
